...
public class MemUtils {
	...
	public static long[] getPrivDirty(Context context, int pid) {
		...
		Log.d("Sampler", "nativePrivateDirty: " +  pidMemoryInfo.nativePrivateDirty/1024+ "MB" +"  dalvikPrivateDirty："+pidMemoryInfo.dalvikPrivateDirty/1024 + "MB"+";getTotalPrivateDirty"+pidMemoryInfo.getTotalPrivateDirty()/1024 + "MB"+" pid:"+ Process.myPid());
	...
	public static long[] getPSS(Context context, int pid) {
		...
		if (pid >= 0) {
			...
			Log.d("Sampler", "nativePss: " +  pidMemoryInfo.nativePss/1024+ "MB" +"  dalvikPss："+pidMemoryInfo.dalvikPss/1024 + "MB"+";getTotalPss"+pidMemoryInfo.getTotalPss()/1024 + "MB"+" pid:"+ Process.myPid());
		} else {
			value[0] = 0;
			value[1] = 0;
			value[2] = 0;
